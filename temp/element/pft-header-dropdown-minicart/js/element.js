define(
    ...
    function($, ko, pubsub) {
        ...
        return {
            elementName: 'pft-header-dropdown-minicart',
            ...
            onLoad: function(widget) {
                ...
                if (widget.hasOwnProperty('miniCartNumberOfItems')) {
                    ...
                    widget.computeDropdowncartHeight = function() {
                        var itemHeight = $("#CC-PFTheaderWidget #dropdowncart .item").css("height");
                    ...
                    $.Topic(pubsub.topicNames.GWP_QUALIFIED_MESSAGE).subscribe(function(message) {
                        widget['pft-header-dropdown-minicart'].gwpQualifiedMessage(message.summary);
                    });
                    $.Topic(pubsub.topicNames.GWP_CLEAR_QUALIFIED_MESSAGE).subscribe(function() {
                        widget['pft-header-dropdown-minicart'].gwpQualifiedMessage(null);
                    });
