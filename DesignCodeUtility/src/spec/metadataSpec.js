...
describe("Metadata Handler", () => {
  ...
  it("should get Theme metadata from target server in transfer mode", (done) => {
    ...
    self.metadata.initializeMetadata().then(
      () => self.metadata.readMetadata(themeDirectoryPath, constants.themeMetadataJson).then(
        (metadata) => {
  ...
  it("should tell you when it cannot get Theme metadata from the target server in transfer mode", (done) => {
    ...
    self.metadata.initializeMetadata().then(
      () => self.metadata.readMetadata(otherThemeDirectoryPath, constants.themeMetadataJson).then(
        (metadata) => {
  ...
  it("should get Global Element metadata from target server in transfer mode", (done) => {
    ...
    self.metadata.initializeMetadata().then(
      () => self.metadata.readMetadata(elementTemplatePath, constants.elementMetadataJson).then(
        (metadata) => {
  ...
  it("should get Widget Element metadata from target server in transfer mode", (done) => {
    ...
    self.metadata.initializeMetadata().then(
      () => self.metadata.readMetadata(widgetElementTemplatePath, constants.elementMetadataJson).then(
        (metadata) => {
  ...
  it("should get Stack Instance metadata from target server in transfer mode", (done) => {
    ...
    self.metadata.initializeMetadata().then(
      () => self.metadata.readMetadata(stackInstanceTemplatePath, constants.stackInstanceMetadataJson).then(
        (metadata) => {
  ...
  it("should tell you when you cannot get Stack Instance metadata from target server in transfer mode", (done) => {
    ...
    self.metadata.initializeMetadata().then(
      () => self.metadata.readMetadata(otherStackInstanceTemplatePath, constants.stackInstanceMetadataJson).then(
        (metadata) => {
  ...
  it("should get Widget metadata from target server in transfer mode", (done) => {
    ...
    self.metadata.initializeMetadata().then(
      () => self.metadata.readMetadata(widgetJsPath, constants.widgetMetadataJson).then(
        (metadata) => {
  ...
  it("should tell you when it cannot get Widget metadata from target server in transfer mode", (done) => {
    ...
    self.metadata.initializeMetadata().then(
      () => self.metadata.readMetadata(otherWidgetJsPath, constants.widgetMetadataJson).then(
        (metadata) => {
  ...
  it("should get Widget instance metadata from target server in transfer mode", (done) => {
    ...
    self.metadata.initializeMetadata().then(
      () => self.metadata.readMetadata(widgetInstanceTemplatePath, constants.widgetInstanceMetadataJson).then(
        (metadata) => {
  ...
  it("should tell you when it cannot get Widget instance metadata from target server in transfer mode", (done) => {
    ...
    self.metadata.initializeMetadata().then(
      () => self.metadata.readMetadata(otherWidgetInstanceTemplatePath, constants.widgetInstanceMetadataJson).then(
        (metadata) => {
  ...
  it("should return config metadata from disk in transfer mode", (done) => {
    ...
    self.metadata.initializeMetadata().then(
      () => self.metadata.readMetadata(otherWidgetInstanceTemplatePath, constants.configMetadataJson)).then(
      (metadata) => {
